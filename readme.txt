...
Using this Team member plugin, you can create a team member section easily within WordPress Block Editor.

**Completely Customizable:** You can customize the with image, designation etc. to make it just the way you need.
